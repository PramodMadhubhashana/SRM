...
class Nonstafflist extends StatefulWidget {
  final String id;
  const Nonstafflist({super.key, required this.id});

  @override
  State<Nonstafflist> createState() => _NonstafflistState();
}

class _NonstafflistState extends State<Nonstafflist> {
      ...
      body: SafeArea(
        child: Row(
          children: [
            ...
            Expanded(
              child: StreamBuilder(
                stream: _authService.getnonacadmicstaff(),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return const Center(child: Text("No Non Staff"));
                  }
